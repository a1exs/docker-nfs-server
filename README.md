...
It`s fork of erichough/nfs-server v2.2.1
...
1. **Expose the server ports**
   ...
   You'll need to open up at least one server port for your client connections. The ports listed in the examples below are the defaults used by this image and most can be [customized](doc/advanced/ports.md).
...
Please [open an issue](https://github.com/a1exs/docker-nfs-server/issues) if you have any questions, constructive criticism, or can't get something to work.
